...
\draw[decorate,decoration={brace,mirror,raise=2pt}, thick] (index.eight split west) to node [annotation,text width=40pt,left=5pt] {Number of chunks} (index.south west);
\node[annotation,below=2pt of sblock0] {SB$_0$};
\node[annotation,below=2pt of sblock1] {SB$_1$};
\node[annotation,below=2pt of sblock2] {SB$_2$};
\node[annotation,below=2pt of sblock3] {SB$_3$};
\node[annotation,below=2pt of sblock4] {SB$_4$};
\node[annotation,above=2pt of index] {Index block};
