...
We decided to change the name of the function rather than fix the old function by adding the {\tt fapl\_id} argument for bacward compatibilty issues and the better representation of what the function does with the new name.
