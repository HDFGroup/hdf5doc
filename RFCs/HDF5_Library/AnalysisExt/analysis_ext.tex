...
contain attribute, object and region references, and stored in-memory, i.e., using
the existing core driver. A new view is created by the
...
\add[JS]{As mentioned, the created view may also need to be persisted and this
can be done by calling \textit{H5Ocopy()} to copy the group (stored in a virtual
