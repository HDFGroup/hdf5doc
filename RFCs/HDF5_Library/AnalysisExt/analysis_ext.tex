...
\revision{February 25, 2015}{Version 4 edits and typo fixing.}
...
\item New \textit{view} objects\footref{fn:object} and API routines, which apply a query to an HDF5
...
objects are run-time, in-memory objects (i.e., not stored in a container) that
