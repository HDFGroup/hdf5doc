 ...
 *		our data sets.  Again, please note that our write strategy
 ...
 *		journal becomes irrelevant after the metadata journal is 
 *		flushed.
 *
 * 		After writing data to our data sets, we then do a number of 
