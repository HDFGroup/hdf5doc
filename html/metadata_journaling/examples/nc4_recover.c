 ...
 * data, is intentionally crashed without proper file flush or close.
 * 
...
#define ChunkX 256
#define ChunkY 16
#define H5FILE_NAME        "trecover.nc"
...
create_files(char *filename, char *ctl_filename)
{
    ...
    /* Enable journaling */
    nc_set_metadata_journaling(fileid, 1, JNL_H5FILE_NAME, 16*1024, 4, 1, 0);
